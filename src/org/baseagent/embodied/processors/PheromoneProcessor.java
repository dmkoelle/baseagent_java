...
public class PheromoneProcessor extends Processor<Double, Double> {
    ...
    public void process(EmbodiedAgent agent) {
        ...
        while (desiredDirection > Math.PI) desiredDirection -= 2*Math.PI;
        while (desiredDirection < -Math.PI) desiredDirection += 2*Math.PI;
    ...
    public ConnectedComponent<Double> getLeftInput() { return leftInput; }
    public ConnectedComponent<Double> getRightInput() { return rightInput; }
    public ConnectedComponent<Double> getDirectionOutput() { return directionOutput; }
    public ConnectedComponent<Double> getIntensityOutput() { return intensityOutput; }
}