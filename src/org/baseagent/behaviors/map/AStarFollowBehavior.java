// filepath: p:/Projects/BaseAgent/baseagent_java/src/org/baseagent/behaviors/map/AStarFollowBehavior.java
 ...
 * to follow the resulting cell centers. The behavior attaches the MoveBehavior
...
public class AStarFollowBehavior extends LifecycleBehavior {
    ...
    public void setSpeedDegreesPerStep(double s) { this.speedDegreesPerStep = s; }
