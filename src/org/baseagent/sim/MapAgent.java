...
public class MapAgent extends DrawableAgent {
    ...
    public double getFineX() { return fineX; }
    public double getFineY() { return fineY; }
    public double getHeading() { return heading; }

    public void setTileX(int x) { this.tileX = x; this.fineX = x; setDrawX(x); }
    public void setTileY(int y) { this.tileY = y; this.fineY = y; setDrawY(y); }
    public void setFineX(double x) { this.fineX = x; this.tileX = (int)Math.round(x); setDrawX(x); }
    ...
    public void draw(GridCanvasContext gcc) {
        // Draw agent at lat/lon using slippy tile pixel coordinates for the current slippy zoom stored in gcc.properties
    ...
    // place agent at tile coordinate and keep drawX/Y in tile-space; MapCanvas will convert
