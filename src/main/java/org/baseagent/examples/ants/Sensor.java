...
/**
 * Simple sensor that samples neighboring pheromone intensities and returns a
 * preferred travel direction (radians) or NaN if no signal found.
 */
public class Sensor {
    /**
     * Sense surrounding cells and compute a weighted direction toward higher
     * pheromone. Returns NaN when there is no measurable pheromone.
     */
