    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        canvas.addGridLayerRenderer("food", new GridCellRenderer() {
            ...
            public void drawCell(GridCanvasContext gcc, GridLayer layer, Object value, double xInPixels,
                ...
                gcc.getGraphicsContext().fillOval(xInPixels + widthInPixels * 0.1, yInPixels + heightInPixels * 0.1,
                        widthInPixels * 0.8, heightInPixels * 0.8);
            }
        });
        ...
        // Mouse interactions: left-click to place food, shift+left to place wall,
