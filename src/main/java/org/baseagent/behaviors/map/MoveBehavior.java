...
/**
 * MoveBehavior moves a MapAgent between one or more geographic waypoints (lat,
 * lon). It extends LifecycleBehavior so it can be started/paused by the
 * simulation. By default the behavior loops the waypoint list when it reaches
 * the end.
 */
