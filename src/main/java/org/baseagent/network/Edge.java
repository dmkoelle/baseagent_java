...
public class Edge<T, R> {
    ...
    public boolean equals(Object o) {
        ...
        return (this.getId().equals(e2.getId()) && this.getSourceNode().equals(e2.getSourceNode())
                && this.getDestinationNode().equals(e2.getDestinationNode()));
    }

    @Override
    public int hashCode() {
        return this.getId().hashCode() + 37 * this.getSourceNode().hashCode()
                + 41 * this.getDestinationNode().hashCode();
    }
}
