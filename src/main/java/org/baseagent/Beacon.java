...
public class Beacon extends GridAgent implements HasStep {
    ...
    /**
     * Simulation step - default no-op; beacons may override if they need to change
     * state
     */
    @Override
    ...
    /**
     * Default signal intensity at a given position. Subclasses/instances should
     * override.
     */
    ...
    /**
     * Maximum integer radius (in cells) this beacon can affect. Default 0 = single
