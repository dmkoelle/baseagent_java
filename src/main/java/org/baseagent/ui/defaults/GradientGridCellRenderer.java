...
public class GradientGridCellRenderer implements GridCellRenderer {
    ...
    @Override
    public void drawCell(GridCanvasContext gcc, GridLayer layer, Object value, double xInPixels, double yInPixels,
        ...
        if (!(value instanceof Double)) {
            ...
            throw new IllegalArgumentException(
                    "Cannot use GradientGridCellRenderer on a grid layer that does not consist of Double values");
        }
        ...
        gcc.getGraphicsContext().setFill(new Color(cr, cg, cb, ca));
