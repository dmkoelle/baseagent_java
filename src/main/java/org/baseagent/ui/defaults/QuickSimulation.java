...
public class QuickSimulation {
    ...
    public QuickSimulation(int widthInCells, int heightInCells, int cellWidth, int cellHeight) {
        ...
        canvas.addGridLayerRenderer(GRIDLAYER_DEFAULT, new GridCellRenderer() {
            ...
            private Paint[] colors = new Paint[] { Color.BLACK, Color.RED, Color.WHITE, Color.CYAN, Color.MAGENTA,
                    Color.GREEN, Color.BLUE, Color.YELLOW, Color.ORANGE, Color.BROWN, Color.PINK, Color.DARKGRAY,
                    Color.GRAY, Color.LIGHTGREEN, Color.LIGHTBLUE, Color.LIGHTGRAY };
