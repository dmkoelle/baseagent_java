    ...
    private void initAgent(int bodyWidth, int bodyHeight) {
        ...
        this.setDrawable(new GridDrawable() {
            ...
            public void draw(GridCanvasContext gcc) {
                // TODO: actually, you do want this agent to draw itself if it's asked to by the
                // prime agent
                if ((EmbodiedAgent.this.primeAgent != null) && (EmbodiedAgent.this.primeAgent != EmbodiedAgent.this)) {
                    VisualizationLibrary.drawEmbodiedAgent(gcc.getGraphicsContext(), getCellX(), getCellY(),
                            gcc.getCellWidth(), gcc.getCellHeight(), EmbodiedAgent.this,
                            getColorOrUse(Color.LIGHTBLUE));
                } else {
                    VisualizationLibrary.drawEmbodiedAgent(gcc.getGraphicsContext(), getCellX(), getCellY(),
                            gcc.getCellWidth(), gcc.getCellHeight(), EmbodiedAgent.this,
                            getColorOrUse(Color.LIGHTBLUE));
