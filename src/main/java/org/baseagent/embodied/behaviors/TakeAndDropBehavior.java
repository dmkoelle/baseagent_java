...
public class TakeAndDropBehavior extends LifecycleBehavior implements MessageListener {
    public TakeAndDropBehavior(EmbodiedAgent agent) {
        // TODO - Whoo boy, I don't know about this EmbodiedFullStackBehavior deal. I
        // could come up with 1000 slightly different behaviors.
        // But the IDEA of a full-stack behavior is interesting. By FullStack, I mean a
        // thing that is a Behavior and a Communicator all on its own.
    }
