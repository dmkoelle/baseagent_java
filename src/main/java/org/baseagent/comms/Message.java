...
public class Message {
    ...
    public Message(MessageListener originalSender, MessageListener currentSender, String messageType,
    ...
    public Message(MessageListener originalSender, MessageListener currentSender, String messageType,
            String messageSubtype, Map<String, Object> payload) {
    ...
    /**
     * Generates a new Message object that is a fresh Message object but looks the
     * same as an existing message. (You are responsible for updating the Payload -
     * the returned message will have an empty payload)
     */
