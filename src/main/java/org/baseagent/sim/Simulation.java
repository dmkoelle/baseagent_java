...
public class Simulation {
    ...
    private void indexBeacon(Beacon b) {
        ...
        try {
            if (b.getGridLayer() != null)
                layerName = b.getGridLayer().getLayerName();
        } catch (Exception ex) {
            // ignore
        }
        if (layerName == null)
    ...
    /**
     * Return beacons near (cellX,cellY) on the given layer within integer radius
     * (inclusive) Uses layer-level spatial hashing for efficiency.
     */
