...
public class Grid extends SimulationComponent implements Universe {
    ...
    public String getLayerName() {
        return Grid.DEFAULT_GRID_LAYER;
    }

    public GridLayerStep<?> current() {
        return getGridLayer(Grid.DEFAULT_GRID_LAYER).current();
    }

    public GridLayerStep<?> next() {
        return getGridLayer(Grid.DEFAULT_GRID_LAYER).next();
    }

    public GridLayerUpdateOption getUpdateOption() {
        return getGridLayer(Grid.DEFAULT_GRID_LAYER).getUpdateOption();
    }

    public void setUpdateOption(GridLayerUpdateOption updateOption) {
        getGridLayer(Grid.DEFAULT_GRID_LAYER).setUpdateOption(updateOption);
    }

    public void persist(Object value, int x, int y) {
        getGridLayer(Grid.DEFAULT_GRID_LAYER).persist(value, x, y);
    }
    ...
    public void fill(Object value) {
        getGridLayer(Grid.DEFAULT_GRID_LAYER).fill(value);
    }

    public void fill(Object value, int x1, int y1, int x2, int y2) {
        getGridLayer(Grid.DEFAULT_GRID_LAYER).fill(value, x1, y1, x2, y2);
    }

    public double laplacian_3x3(int x, int y, double centerWeight, double adjacentWeight, double diagonalWeight) {
        return getGridLayer(Grid.DEFAULT_GRID_LAYER).laplacian_3x3(x, y, centerWeight, adjacentWeight, diagonalWeight);
    }

    public void set(int x, int y, Object value) {
        getGridLayer(Grid.DEFAULT_GRID_LAYER).set(x, y, value);
    }

    public void set(GridPosition position, Object value) {
        getGridLayer(Grid.DEFAULT_GRID_LAYER).set(position, value);
    }

    public void clear(int x, int y) {
        getGridLayer(Grid.DEFAULT_GRID_LAYER).clear(x, y);
    }

    public void clear(GridPosition position) {
        getGridLayer(Grid.DEFAULT_GRID_LAYER).clear(position);
    }

    public Object get(int x, int y) {
        return getGridLayer(Grid.DEFAULT_GRID_LAYER).get(x, y);
    }

    public Object get(GridPosition position) {
        return getGridLayer(Grid.DEFAULT_GRID_LAYER).get(position);
    }

    public int count8Neighbors(int x, int y, Predicate<? super Object> predicate) {
        return getGridLayer(Grid.DEFAULT_GRID_LAYER).count8Neighbors(x, y, predicate);
    }

    public int count4Neighbors(int x, int y, Predicate<? super Object> predicate) {
        return getGridLayer(Grid.DEFAULT_GRID_LAYER).count4Neighbors(x, y, predicate);
    }

    public double average9Neighbors(int x, int y) {
        return getGridLayer(Grid.DEFAULT_GRID_LAYER).average9Neighbors(x, y);
    }

    public double average8Neighbors(int x, int y) {
        return getGridLayer(Grid.DEFAULT_GRID_LAYER).average8Neighbors(x, y);
    }

    public double average4Neighbors(int x, int y) {
        return getGridLayer(Grid.DEFAULT_GRID_LAYER).average4Neighbors(x, y);
    }

    public long count(Predicate<Object> predicate) {
        return getGridLayer(Grid.DEFAULT_GRID_LAYER).count(predicate);
    }

    public int getBooleanAsOneOrZero(int x, int y, Predicate<? super Object> predicate) {
        return getGridLayer(Grid.DEFAULT_GRID_LAYER).getBooleanAsOneOrZero(x, y, predicate);
    }

    public void scatter(Object thing) {
        getGridLayer(Grid.DEFAULT_GRID_LAYER).scatter(thing, 1);
    }

    public void scatter(Object thing, int howMany) {
        getGridLayer(Grid.DEFAULT_GRID_LAYER).scatter(thing, howMany);
    }

    public void scatter(Object thing, int howMany, int x1, int y1, int x2, int y2) {
        getGridLayer(Grid.DEFAULT_GRID_LAYER).scatter(thing, howMany, x1, y1, x2, y2);
    }

    public void scatter(List<? super Object> things) {
        getGridLayer(Grid.DEFAULT_GRID_LAYER).scatter(things);
    }

    public void scatter(List<? super Object> things, int x1, int y1, int x2, int y2) {
        getGridLayer(Grid.DEFAULT_GRID_LAYER).scatter(things, x1, y1, x2, y2);
    }

    public void form(Object thing, int x, int y, String... strings) {
        getGridLayer(Grid.DEFAULT_GRID_LAYER).form(thing, x, y, strings);
    }

    public GridPosition getRandomUnoccupiedPosition() {
        return getGridLayer(Grid.DEFAULT_GRID_LAYER).getRandomUnoccupiedPosition();
    }
}