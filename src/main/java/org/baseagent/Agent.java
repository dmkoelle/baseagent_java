...
/**
 * An important aspect about this general Agent is that the only thing it
 * maintains is internal state and knowledge. It does not specifically include
 * those things that connect it to the world, whether that world is a Universe
 * inside within BaseAgent
 * 
 * @author David Koelle
 *
 */
public class Agent extends SimulationComponent implements MessageListener, HasStep {
    ...
    /**
     * By default, the Agent will be sure to pass along any messages to its
     * behaviors that are also listening for messages. When you create a subclass of
     * Agent, you may want to call super.onMessageReceived() or
     * passMessageToBehaviors() to continue this behavior.
     */
    @Override
